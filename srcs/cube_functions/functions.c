...
/*   Updated: 2020/06/05 11:52:50 by ybakker       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int		check_fill(t_struct_m *main)
{
	...
	while (y <= main->Ray.yy)
	{
		if (y == 0 || y == main->Ray.yy)
		{
			while (main->cubecopy[y][x])
			{
				if (main->cubecopy[y][x] != '1' && main->cubecopy[y][x] != ' ')//top and bottom lines
				{
					main->place.error_c = 15;
					ft_error(main);
				}
		...
		else if (main->cubecopy[y][x] != '1' && main->cubecopy[y][x] != ' ')//beginning of each line
		{
		...
		else
		{
			...
			x--;
			if (main->cubecopy[y][x] != '1' && main->cubecopy[y][x] != ' ')//beginning of each line
			{
